  ...
  return (
    ...
    >
      <View style={{ flex: 1, justifyContent: "flex-end" }}>
        {/* 1. Background Overlay (Clicking this closes the modal) */}
        <TouchableOpacity
          style={{
        ...
        {/* 2. Modal Container (We changed this from a TouchableOpacity to a standard View so scrolling works perfectly!) */}
        <View
          style={{
            ...
            maxHeight: "90%",
            paddingBottom: insets.bottom, // Keeps the bottom safe from the iOS home bar
          }}
        >
          {/* Header */}
          <View
          ...
          <Field label="Balance (₹)">
            <StyledInput
              ...
              onChangeText={(v) => {
                ...
                // 2. Allow typing a minus sign or trailing decimal temporarily without parsing it
                if (v === "-" || v.endsWith(".")) {
                  set((p) => ({ ...p, balance: v as any }));
                  return;
                }

                // 3. Clean the string and parse it properly to keep decimals
...
export function InvestmentModal() {
  ...
  return (
    ...
    >
      ...
      {/* --- SHOW DATES & AUTO-SCHEDULE FOR ALL INVESTMENTS --- */}
      <Row>
        <Col>
